...
plt.plot(filtered_data['Date'], filtered_data['London_Male_Percentage_Change'], label='London Male', marker='o', color='blue')
plt.plot(filtered_data['Date'], filtered_data['London_Female_Percentage_Change'], label='London Female', marker='o', color='pink')
